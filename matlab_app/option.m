...
% Last Modified by GUIDE v2.5 17-Dec-2020 10:56:11
...
% guidata(hObject, handles);
% handles_main=guihandles(main);
% wname=handles_main.wname;
% wname = getappdate(handles.figure,'wname');
% lambda = getappdate(handles.figure1,'lambda');

hone=findobj('Tag','figure1');
handles_main=guihandles(hone);
lambda=handles_main.lambda;
